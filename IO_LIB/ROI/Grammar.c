...
#endif
/* Tokens.  */
#define IRREGULAR 258
#define ELLIPTICAL 259
#define RECTANGULAR 260
#define END_REGION 261
#define NAME 262
#define IMAGE 263
#define POINTS 264
#define X0 265
...
{
       0,    55,    55,    58,    60,    63,    68,    68,   128,   130,
     132,   135,   140,   161,   163,   165,   168,   168,   178,   180,
     183,   212,   227,   239,   242,   246
};
#endif
...
{
  "$end", "error", "$undefined", "IRREGULAR", "ELLIPTICAL", "RECTANGULAR",
  "END_REGION", "NAME", "IMAGE", "POINTS", "X0", "Y0", "WIDTH", "HEIGHT",
  "EX0", "EY0", "EA", "EB", "ROT", "ASSIGN", "STRING", "NUMBER", "COMMENT",
  "$accept", "roi_file", "rois", "region", "start_region", "$@1",
  "region_type", "name", "image", "data", "irregular_region_data", "$@2",
  "pairs_of_points", "pair_of_points", "elliptical_region_data",
  "rectangular_region_data", "number", "end_region", "string", YY_NULLPTR
};
#endif
...
{
       2,   -20,   -20,   -20,     9,   -20,     2,    -6,   -20,   -20,
     -20,    -9,    -8,    -7,     7,   -20,   -20,   -20,     8,    -5,
      -5,    -5,   -20,   -20,    -2,     6,   -20,   -20,    10,     3,
      -1,     1,   -20,    -5,    11,    12,   -20,   -20,    -1,   -20,
      -5,    -5,    -5,    -5,   -20,   -20,   -20,    13,    18,    16,
      17,    -5,    -5,    14,    20,    21,    22,    -5,    -5,   -20,
      24,    25,    -5,   -20
};
...
{
       0,     8,    10,     9,     0,     2,     3,     0,     6,     1,
       4,     0,     0,     0,     0,    13,    14,    15,     0,     0,
       0,     0,    24,     5,     0,     0,    23,    16,     0,     0,
       0,     0,     7,     0,     0,     0,    25,    11,     0,    17,
      18,     0,     0,     0,    12,    19,    20,     0,     0,     0,
...
static const yytype_int8 yypgoto[] =
{
     ...
     -20,   -20,   -14,   -20,   -20,   -20,   -19,   -20,   -10
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,     6,     7,    18,     8,    25,    32,    14,
      15,    33,    39,    40,    16,    17,    41,    23,    37
};
...
{
      27,    28,    29,    11,    12,     1,     2,     3,    13,     9,
      19,    20,    21,    22,    31,    24,    26,    30,    35,    36,
      38,    34,    46,    47,    48,    49,    45,    55,    44,    10,
      42,    43,    53,    54,    50,    51,    52,    56,    59,    60,
      57,    58,    61,    63,    62
};

static const yytype_uint8 yycheck[] =
{
      19,    20,    21,     9,    10,     3,     4,     5,    14,     0,
      19,    19,    19,     6,     8,     7,    21,    19,    15,    20,
      19,    11,    41,    42,    43,    12,    40,    13,    38,     6,
      19,    19,    51,    52,    16,    19,    19,    17,    57,    58,
      19,    19,    18,    62,    19
};
...
{
       0,     3,     4,     5,    24,    25,    26,    27,    29,     0,
      25,     9,    10,    14,    32,    33,    37,    38,    28,    19,
      19,    19,     6,    40,     7,    30,    21,    39,    39,    39,
      19,     8,    31,    34,    11,    15,    20,    41,    19,    35,
      36,    39,    19,    19,    41,    35,    39,    39,    39,    12,
      16,    19,    19,    39,    39,    13,    17,    19,    19,    39,
      39,    18,    19,    39
};
...
{
       0,    23,    24,    25,    25,    26,    28,    27,    29,    29,
      29,    30,    31,    32,    32,    32,    34,    33,    35,    35,
      36,    37,    38,    39,    40,    41
};
...
#line 65 "Grammar.y" /* yacc.c:1646  */
    { numRois++; }
#line 1308 "Grammar.c" /* yacc.c:1646  */
    break;
...
#line 1369 "Grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 128 "Grammar.y" /* yacc.c:1646  */
    { aRegionType = IRREGULAR_ROI_REGION; }
#line 1375 "Grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 130 "Grammar.y" /* yacc.c:1646  */
    { aRegionType = RECTANGULAR_ROI_REGION; }
#line 1381 "Grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 132 "Grammar.y" /* yacc.c:1646  */
    { aRegionType = ELLIPTICAL_ROI_REGION; }
#line 1387 "Grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 135 "Grammar.y" /* yacc.c:1646  */
    {
		myRois[numRois]->name = (yyvsp[0]); /* strdup already done, thanks */
	}
...
#line 183 "Grammar.y" /* yacc.c:1646  */
    {
			...
			anIrregularRegion->points[anIrregularRegion->num_points]->x = atof((yyvsp[-1]));
			anIrregularRegion->points[anIrregularRegion->num_points]->y = atof((yyvsp[0]));
...
#line 1462 "Grammar.c" /* yacc.c:1646  */
    break;

  case 21:
#line 217 "Grammar.y" /* yacc.c:1646  */
    {
		anEllipticalRegion->ex0 = atof((yyvsp[-12]));
		anEllipticalRegion->ey0 = atof((yyvsp[-9]));
		anEllipticalRegion->ea  = atof((yyvsp[-6]));
		anEllipticalRegion->eb  = atof((yyvsp[-3]));
		anEllipticalRegion->rot = atof((yyvsp[0]));
	}
...
#line 231 "Grammar.y" /* yacc.c:1646  */
    {
		aRectangularRegion->x0 = atof((yyvsp[-9]));
		aRectangularRegion->y0 = atof((yyvsp[-6]));
		aRectangularRegion->width = atof((yyvsp[-3]));
		aRectangularRegion->height = atof((yyvsp[0]));
	}
...
#line 249 "Grammar.y" /* yacc.c:1906  */
